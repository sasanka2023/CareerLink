...
import { EnvelopeIcon, PhoneIcon, GlobeAltIcon, UserIcon } from '@heroicons/react/24/outline';
...
const CV3 = () => {
    ...
    const CVPreview = () => (
        <div ref={cvPreviewRef} style={{ display: 'none', backgroundColor: '#fff', padding: '20px', marginTop: '20px', border: '1px solid #ccc', fontFamily: 'Arial, sans-serif' }}>
            <div style={{ display: 'flex', backgroundColor: '#0d47a1', color: '#fff', padding: '20px' }}>
                <div style={{ flex: '1' }}>
                ...
                <div style={{ flex: '1' }}>
                    ...
                    <p><PhoneIcon className="h-5 w-5 inline mr-2" /> {formData.personalDetails.phone || '+44 123 456 7890'}</p>
                    <p>{formData.personalDetails.address || '123 Main St, City'}</p>
                    <p><GlobeAltIcon className="h-5 w-5 inline mr-2" /> <a href={formData.personalDetails.website || '#'} style={{ color: '#fff' }}>{formData.personalDetails.website || 'website.com'}</a></p>
            ...
            <div style={{ display: 'flex', marginTop: '20px' }}>
                <div style={{ flex: '1', paddingRight: '20px', backgroundColor: '#0d47a1', color: '#fff' }}>
                    ...
                    <h3 style={{ fontSize: '18px', marginTop: '20px', marginBottom: '10px' }}>Certificates</h3>
                    {formData.certificates.map((cert, index) => cert.name && (
                        <p key={index}>{cert.name} - {cert.issuer}, {cert.date}</p>
                    ))}
                </div>

                <div style={{ flex: '2' }}>
                    <h3 style={{ fontSize: '18px', marginBottom: '10px' }}>{formData.headline || 'Professional Headline'}</h3>
    ...
    return (
        <DashboardLayout>
            <div className="p-6 max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold text-center mb-8">Content Marketing CV Builder</h1>
                ...
                <form className="space-y-8">
                            ...
                            <div className="relative">
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange('personalDetails', 'website', e.target.value)}
                                        className="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                    />
                                </div>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <input
                            ...
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            placeholder="e.g., Results-Focused Content Marketer with Experience Leading £1M Large-Scale Website Project"
                            required
                        />
                    </div>
