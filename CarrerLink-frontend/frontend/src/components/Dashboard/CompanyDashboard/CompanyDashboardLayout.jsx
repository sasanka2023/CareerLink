...
function CompanyDashboardLayout({ children }) {
  ...
  const navigationItems = [
    ...
    { path: "/company-dashboard/cv-list", icon: FileText, label: "CV List" },
    { path: "/company-dashboard/about", icon: Users, label: "About Us" },
    { path: "/company-dashboard/contact", icon: Mail, label: "Contact Us" },
  ];
